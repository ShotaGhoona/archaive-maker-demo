...
export const productDocuments: Document[] = [
  // PRD-ARM-1000 産業用ロボットアーム Rev.B
  {
    ...
    s3Path: 'https://picsum.photos/seed/document1/400/300',
  ...
  },
  {
    ...
    s3Path: 'https://picsum.photos/seed/document2/400/300',
  ...
  },
  {
    ...
    s3Path: 'https://picsum.photos/seed/document3/400/300',
  ...
  // PRD-AGV-2000 AGV Rev.A
  {
    ...
    documentTypeId: 'DT-SPEC',
    s3Path: 'https://picsum.photos/seed/document4/400/300',
  ...
  },
  {
    ...
    itemRevId: 'REV-PRD-002-A',
    documentTypeId: 'DT-QUOTE',
    s3Path: 'https://picsum.photos/seed/document5/400/300',
...
export const assemblyDocuments: Document[] = [
  // ASY-BASE-100 ベースユニット
  {
    ...
    s3Path: 'https://picsum.photos/seed/document6/400/300',
  ...
  },
  {
    ...
    itemRevId: 'REV-ASY-001-A',
    documentTypeId: 'DT-WI',
    s3Path: 'https://picsum.photos/seed/document7/400/300',
  ...
  // ASY-CTL-130 制御ボード Rev.B
  {
    ...
    documentTypeId: 'DT-IR',
    s3Path: 'https://picsum.photos/seed/document8/400/300',
  ...
  // ASY-END-300 エンドエフェクター
  {
    ...
    documentTypeId: 'DT-IR',
    s3Path: 'https://picsum.photos/seed/document9/400/300',
  ...
  // ASY-BAT-700 バッテリーユニット
  {
    ...
    documentTypeId: 'DT-IR',
    s3Path: 'https://picsum.photos/seed/document10/400/300',
...
export const purchasedDocuments: Document[] = [
  // PUR-MTR-001 サーボモーター
  {
    ...
    s3Path: 'https://picsum.photos/seed/document11/400/300',
  ...
  },
  {
    ...
    s3Path: 'https://picsum.photos/seed/document12/400/300',
  ...
  },
  {
    ...
    s3Path: 'https://picsum.photos/seed/document13/400/300',
  ...
  // PUR-ENC-001 エンコーダ
  {
    ...
    documentTypeId: 'DT-PO',
    s3Path: 'https://picsum.photos/seed/document14/400/300',
  ...
  // PUR-CPU-001 マイコン
  {
    ...
    documentTypeId: 'DT-PO',
    s3Path: 'https://picsum.photos/seed/document15/400/300',
  ...
  // PUR-BRG-001 ベアリング
  {
    ...
    documentTypeId: 'DT-PO',
    s3Path: 'https://picsum.photos/seed/document16/400/300',
  ...
  // PUR-LDR-001 LiDARセンサー
  {
    ...
    documentTypeId: 'DT-PO',
    s3Path: 'https://picsum.photos/seed/document17/400/300',
  ...
  // PUR-BAT-001 リチウムイオン電池
  {
    ...
    documentTypeId: 'DT-PO',
    s3Path: 'https://picsum.photos/seed/document18/400/300',
...
export const shipmentDocuments: Document[] = [
  // PRD-ARM-1000 出荷検査表
  {
    ...
    s3Path: 'https://picsum.photos/seed/document19/400/300',
  ...
  },
  {
    ...
    itemRevId: 'REV-PRD-001-B',
    documentTypeId: 'DT-DN',
    s3Path: 'https://picsum.photos/seed/document20/400/300',
  ...
  },
  {
    ...
    itemRevId: 'REV-PRD-001-B',
    documentTypeId: 'DT-INV',
    s3Path: 'https://picsum.photos/seed/document21/400/300',
  ...
  // PRD-AGV-2000 出荷検査表
  {
    ...
    itemRevId: 'REV-PRD-002-A',
    documentTypeId: 'DT-SI',
    s3Path: 'https://picsum.photos/seed/document22/400/300',

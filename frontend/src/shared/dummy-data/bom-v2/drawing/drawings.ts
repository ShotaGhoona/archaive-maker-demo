...
export const productDrawings: Drawing[] = [
  // PRD-ARM-1000 産業用ロボットアーム Rev.B
  {
    ...
    sheetNumber: 1,
    totalSheets: 1,
    filePath: '/drawings/PRD-ARM-1000-B/overview.pdf',
  ...
  // PRD-AGV-2000 AGV Rev.A
  {
    ...
    sheetNumber: 1,
    totalSheets: 1,
    filePath: '/drawings/PRD-AGV-2000-A/overview.pdf',
...
export const assemblyDrawings: Drawing[] = [
  // ASY-BASE-100 ベースユニット
  {
    ...
    sheetNumber: 1,
    totalSheets: 2,
    filePath: '/drawings/ASY-BASE-100-A/assembly-1.pdf',
  ...
  },
  {
    ...
    sheetNumber: 2,
    totalSheets: 2,
    filePath: '/drawings/ASY-BASE-100-A/assembly-2.pdf',
  ...
  // ASY-DRV-110 駆動システム Rev.B
  {
    ...
    sheetNumber: 1,
    totalSheets: 1,
    filePath: '/drawings/ASY-DRV-110-B/assembly.pdf',
  ...
  // ASY-FRM-120 フレーム構造
  {
    ...
    sheetNumber: 1,
    totalSheets: 1,
    filePath: '/drawings/ASY-FRM-120-A/assembly.pdf',
  ...
  // ASY-CTL-130 制御ボード Rev.B
  {
    ...
    sheetNumber: 1,
    totalSheets: 2,
    filePath: '/drawings/ASY-CTL-130-B/wiring-1.pdf',
  ...
  },
  {
    ...
    sheetNumber: 2,
    totalSheets: 2,
    filePath: '/drawings/ASY-CTL-130-B/circuit.pdf',
  ...
  // ASY-ARM-200 アームユニット
  {
    ...
    sheetNumber: 1,
    totalSheets: 1,
    filePath: '/drawings/ASY-ARM-200-A/assembly.pdf',
  ...
  // ASY-END-300 エンドエフェクター
  {
    ...
    sheetNumber: 1,
    totalSheets: 1,
    filePath: '/drawings/ASY-END-300-A/assembly.pdf',
  ...
  // ASY-GRP-310 グリッパー機構
  {
    ...
    sheetNumber: 1,
    totalSheets: 1,
    filePath: '/drawings/ASY-GRP-310-A/assembly.pdf',
  ...
  // ASY-CHS-500 シャーシユニット
  {
    ...
    sheetNumber: 1,
    totalSheets: 1,
    filePath: '/drawings/ASY-CHS-500-A/assembly.pdf',
  ...
  // ASY-NAV-600 ナビゲーションユニット
  {
    ...
    sheetNumber: 1,
    totalSheets: 1,
    filePath: '/drawings/ASY-NAV-600-A/wiring.pdf',
  ...
  // ASY-BAT-700 バッテリーユニット
  {
    ...
    sheetNumber: 1,
    totalSheets: 1,
    filePath: '/drawings/ASY-BAT-700-A/assembly.pdf',
...
export const partDrawings: Drawing[] = [
  // PRT-GER-001 減速ギア Rev.B
  {
    ...
    sheetNumber: 1,
    totalSheets: 1,
    filePath: '/drawings/PRT-GER-001-B/part.pdf',
  ...
  // PRT-PLT-001 ベースプレート
  {
    ...
    sheetNumber: 1,
    totalSheets: 1,
    filePath: '/drawings/PRT-PLT-001-A/part.pdf',
  ...
  // PRT-COL-001 支柱
  {
    ...
    sheetNumber: 1,
    totalSheets: 1,
    filePath: '/drawings/PRT-COL-001-A/part.pdf',
  ...
  // PRT-SFT-001 シャフト
  {
    ...
    sheetNumber: 1,
    totalSheets: 1,
    filePath: '/drawings/PRT-SFT-001-A/part.pdf',
  ...
  // PRT-ARM-001 アーム部材
  {
    ...
    sheetNumber: 1,
    totalSheets: 1,
    filePath: '/drawings/PRT-ARM-001-A/part.pdf',
  ...
  // PRT-JNT-001 ジョイント
  {
    ...
    sheetNumber: 1,
    totalSheets: 1,
    filePath: '/drawings/PRT-JNT-001-A/part.pdf',
  ...
  // PRT-FNG-001 フィンガー部品
  {
    ...
    sheetNumber: 1,
    totalSheets: 1,
    filePath: '/drawings/PRT-FNG-001-A/part.pdf',
  ...
  // PRT-WHL-001 駆動ホイール
  {
    ...
    sheetNumber: 1,
    totalSheets: 1,
    filePath: '/drawings/PRT-WHL-001-A/part.pdf',
  ...
  // PRT-FRM-002 シャーシフレーム
  {
    ...
    sheetNumber: 1,
    totalSheets: 1,
    filePath: '/drawings/PRT-FRM-002-A/part.pdf',

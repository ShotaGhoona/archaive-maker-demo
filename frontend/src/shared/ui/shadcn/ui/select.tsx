...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        'flex w-fit items-center justify-between gap-2 whitespace-nowrap rounded-xl px-3 py-2 text-sm outline-none transition-all duration-200',
        'border border-white/60 bg-white/40 backdrop-blur-xl',
        'text-slate-700 shadow-[0_4px_16px_rgba(0,0,0,0.06)]',
        'hover:bg-white/60 hover:shadow-[0_4px_20px_rgba(0,0,0,0.1)]',
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          'max-h-(--radix-select-content-available-height) origin-(--radix-select-content-transform-origin) relative z-50 min-w-[8rem] overflow-y-auto overflow-x-hidden',
          'rounded-xl border border-white/60 bg-white/80 backdrop-blur-xl',
          'text-slate-700 shadow-[0_8px_32px_rgba(0,0,0,0.12)]',

    ...
    <div className='relative min-h-full bg-neutral-50 dark:bg-neutral-950'>
        ...
        <div className='mx-auto max-w-5xl'>
          ...
          <div className='mb-8 flex items-center justify-between'>
            ...
            >
              ...
              コマンドパレット
              <kbd className='ml-2 rounded bg-white/20 px-1.5 py-0.5 text-xs dark:bg-neutral-900/20'>
                ⌘K
              </kbd>
            </button>
          </div>
      ...
      {isOpen && (
        <div className='fixed inset-0 z-50 flex items-start justify-center pt-[15vh]'>
          ...
          {/* パレット本体 */}
          <div className='relative w-full max-w-2xl duration-200 animate-in fade-in slide-in-from-top-4'>
            <div className='overflow-hidden rounded-2xl border border-neutral-200 bg-white shadow-2xl dark:border-neutral-800 dark:bg-neutral-900'>
              ...
              <div className='max-h-[400px] overflow-auto p-2'>
                {query ? (
                  // 検索結果
                  <div>
                    <p className='px-3 py-2 text-xs font-medium text-neutral-400'>
                      検索結果
                    </p>
              ...
              <div className='flex items-center justify-between border-t border-neutral-100 px-4 py-3 dark:border-neutral-800'>
                <div className='flex items-center gap-4 text-xs text-neutral-400'>
                  <span className='flex items-center gap-1'>
                    <kbd className='rounded border border-neutral-200 bg-neutral-100 px-1 dark:border-neutral-700 dark:bg-neutral-800'>
                      ↑↓
                    </kbd>
                    移動
                  </span>
                ...
                <div className='flex items-center gap-1 text-xs text-neutral-400'>
                  ...
                  <span>お気に入りに追加</span>
                  <kbd className='ml-1 rounded border border-neutral-200 bg-neutral-100 px-1 dark:border-neutral-700 dark:bg-neutral-800'>
                    ⌘S
                  </kbd>
                </div>
              </div>

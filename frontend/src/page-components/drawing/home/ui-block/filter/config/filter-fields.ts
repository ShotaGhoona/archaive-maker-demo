...
export const FILTER_FIELDS: FilterFieldConfig[] = [
  ...
  {
    key: 'externalDrawingNumber',
    label: '外部図番',
    type: 'text',
    placeholder: '外部図番を入力',
  },
  {
    key: 'leafProductRevisionNumber',
    label: 'Rev',
    type: 'multiselect',
    options: revisionOptions,
  },
  {
    key: 'drawingCategoryName',
    label: 'カテゴリ',
    type: 'multiselect',
    options: drawingCategoryOptions,
  },
  {
    key: 'customerName',
    label: '顧客',
  ...
  },
  {
    ...
    label: '作成者',
    type: 'user',
    userOptions: employeeUserOptions,
  },
